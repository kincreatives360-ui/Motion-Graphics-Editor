...
export interface SceneTemplate {
  ...
  name: string;
  description: string;
  category?: "titles" | "broadcast" | "layout" | "showcase" | "user";
  durationFrames: number;
  fps: number;
  layers: Layer[];
...
export const BUILT_IN_SCENE_TEMPLATES: SceneTemplate[] = [
  ...
  {
    id: "template-3d-mobile-showcase",
    name: "3D Mobile App Showcase",
    description: "Cinematic product video featuring a 3D-tilted iPhone 16 Pro mockup, floating metric badge, and camera push-in",
    category: "showcase",
    durationFrames: 180,
    fps: 30,
    camera: {
    ...
    layers: [
      {
        ...
        locked: false,
        text: {
          content: "CINEMATIC PRODUCT EXPERIENCES",
          fontSize: 38,
          fontFamily: "Inter, system-ui, sans-serif",
          color: "#ffffff",
          align: "left",
      ...
      },
      {
        ...
        locked: false,
        text: {
          content: "Turn interfaces into studio-grade 3D motion videos with rack focus and lighting.",
          fontSize: 18,
          fontFamily: "Inter, system-ui, sans-serif",
          color: "#94a3b8",
          align: "left",
  ...
  {
    id: "template-saas-laptop-showcase",
    name: "Cinematic SaaS Laptop Showcase",
    description: "Desktop product video with MacBook Pro mockup, 3D perspective swivel, and smooth camera dolly",
    category: "showcase",
    durationFrames: 180,
    fps: 30,
    camera: {
    ...
    layers: [
      {
        ...
        locked: false,
        text: {
          content: "NEXT-GEN CREATIVE WORKSPACE",
          fontSize: 32,
          fontFamily: "Inter, system-ui, sans-serif",
          color: "#ffffff",
          align: "center",
